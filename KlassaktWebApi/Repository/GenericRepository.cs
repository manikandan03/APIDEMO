...
namespace KlassaktWebApi.Repository
{
    public class GenericRepository<T> : IGenericRepository<T>, IDisposable where T : class
    {
        ...
        public GenericRepository(IUnitOfWork<LMSContentEntities> unitOfWork) : this(unitOfWork.Context)
        {
        }
        ...
        public LMSContentEntities Context { get; set; }
